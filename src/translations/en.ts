export const en = {
	...
	quiz: {
		setup: {
			title: "Quiz Setup",
			description: "Choose category and difficulty for your quiz",
			category: "Select Category",
			difficultyAndQuestions: "Difficulty and Number of Questions",
		...
		complete: {
			...
			tryAgain: "Try again, you'll do better next time!",
